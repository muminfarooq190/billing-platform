...
public sealed class UploadBookingDocumentCommandHandler(
    ...
    IUnitOfWork unitOfWork, Api.ITenantContext tenantContext) : IRequestHandler<UploadBookingDocumentCommand, UploadBookingDocumentResult>
{
    ...
    {
        await featureGate.EnsureEnabledAsync(FeatureKeys.TravelBookingDocumentsUpload, request.TenantId, tenantContext.UserId, cancellationToken);
