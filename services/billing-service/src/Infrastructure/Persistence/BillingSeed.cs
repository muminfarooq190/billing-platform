...
public static class BillingSeed
{
    ...
    private static async Task SeedFeatureCatalogAsync(BillingDbContext dbContext, CancellationToken cancellationToken)
    {
        ...
        var entries = new[]
        {
            ...
            FeatureCatalogEntry.Create("travel.workflowHub", "travel-service", "travel", "Workflow hub", "Allows tenant to access workflow hub.", assignmentMode: FeatureAssignmentMode.TenantWide),
    ...
    private static IReadOnlyList<CommercialPackageFeature> CreateLegacyFeatures(Guid packageId, PlanType planType)
        => planType switch
        {
            ...
            [
                ...
                CommercialPackageFeature.Create(packageId, "travel.workflowHub", false),
            ...
            [
                ...
                CommercialPackageFeature.Create(packageId, "travel.workflowHub", true),
                CommercialPackageFeature.Create(packageId, "travel.audit.read", false),
