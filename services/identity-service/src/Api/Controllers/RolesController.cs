...
public sealed class RolesController(IdentityDbContext dbContext, IFeatureGate featureGate, ITenantContext tenantContext) : ControllerBase
{
    [HttpGet("permissions")]
    ...
    public async Task<IActionResult> GetRoles(CancellationToken cancellationToken)
    {
        ...
        await featureGate.EnsureEnabledAsync(FeatureKeys.IdentityRbacAdvanced, tenantId, tenantContext.UserId, cancellationToken);
