...
public sealed class TenantBrandingController(IdentityDbContext dbContext, IBrandAssetStorage storage, IFeatureGate featureGate, ITenantContext tenantContext) : ControllerBase
{
    [HttpGet]
